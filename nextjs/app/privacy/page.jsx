  ...
  return (
    <main style={wrap}>
      ...
      <p style={p}>
        ...
        обрабатывает персональные данные посетителей и использует файлы cookie.
      </p>

      <h2 style={h2}>2. Какие данные мы обрабатываем</h2>
      <ul>
        <li style={li}>
          <strong>Обезличенные данные посещения</strong>, которые сервис аналитики Яндекс.Метрика
          собирает только после вашего согласия: IP-адрес, файлы cookie, данные об устройстве и браузере,
      ...
      <p style={p}>
        Обработка ведётся на основании вашего согласия (для веб-аналитики — нажатие «Принять»
        в уведомлении о cookie), а также в связи с исполнением обращения, которое вы инициировали.
      </p>
